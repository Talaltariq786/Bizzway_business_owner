          ...
          LayoutBuilder(
            builder: (context, constraints) {
              ...
              Widget card({
                ...
                return UserTypeToggleCard(
                  title: title,
                  subtitle: subtitle,
                  isSelected: selected,
                  onTap: onTap,
                  expandInParent: !useScroll,
                );
              }
              ...
              final row = Row(
                children: [
                  card(
                    ...
                    selected: loginUserType == UserType.businessOwner,
                  ...
                  card(
                    ...
                    selected: loginUserType == UserType.customer,
                  ...
                  card(
                    ...
                    selected: loginUserType == UserType.serviceWorker,
              ...
              child: Text(
                loginUserType == UserType.serviceWorker
                    ? (loginServiceBranch == ServiceBranch.rider
                        ? 'Rider login uses your phone number'
                        : 'Home services — login with phone')
                    : 'You will sign in with phone only',
